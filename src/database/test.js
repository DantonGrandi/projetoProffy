...
Database.then( async (db) => {
    ...
    proffyValue = {
        name: "Danton Grandi",
        avatar: "https://avatars3.githubusercontent.com/u/25828134?s=460&u=33188ddf7ce153818777e775e5ddf9abed215d59&v=4",
        whatsapp: "8945654899",
    ...
    classScheduleValues = [
        // o class_id virá pelo banco de dados após cadastrasmos a class
        {
            weekday: 0,
            time_from: 720,
            time_to: 1220
    ...
    // o horário que a pessoa trabalha, por exemplo, é das 8hrs as 18hrs
    // o horário do time_from (8hrs) prescisa ser menor ou igual ao horário solicitado
